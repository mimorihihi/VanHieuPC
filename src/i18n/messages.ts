...
export async function getMessages(localeInput: string | undefined | null) {
  ...
  if (locale === "en") {
    const [header, cart, checkout, home, footer, payment, dashboard] = await Promise.all([
    ...
    return mergeMessages(header.default, cart.default, checkout.default, home.default, footer.default, payment.default, dashboard.default)
  }
